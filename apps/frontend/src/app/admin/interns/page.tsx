  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Daftar Intern</h1>
        <p className="text-gray-600">Total: {meta?.total || 0} intern</p>
      </div>
      ...
      {loading ? (
        ...
        <Card>
          <p className="text-gray-500 text-center py-8">Belum ada intern terdaftar</p>
        </Card>
      ) : (
        <>
          <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-8">
                    <div className="text-center">
                      <p className="text-xl font-bold text-blue-600">{intern._count.activities}</p>
                      <p className="text-xs text-gray-500">Aktivitas</p>
                    </div>
                    <div className="text-center">
                      <p className="text-xl font-bold text-green-600">{intern._count.attendances}</p>
                    ...
                    <div className="text-right">
                      {intern.supervisor ? (
                        ...
                        <p className="text-sm text-yellow-600">Belum ada supervisor</p>
                      )}
