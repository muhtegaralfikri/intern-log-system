                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-6">
                    <div className="grid grid-cols-3 gap-4 text-center">
                      <div>
                        <p className="font-bold text-blue-600">{user._count.activities}</p>
                        <p className="text-xs text-gray-500">Aktivitas</p>
                      </div>
                      <div>
                        <p className="font-bold text-green-600">{user._count.attendances}</p>
                        <p className="text-xs text-gray-500">Kehadiran</p>
                      </div>
                      <div>
                        <p className="font-bold text-purple-600">{user._count.reports}</p>
